...
class User extends \Core\Model {
  ...
  /**
   * Remember the login by inserting a new unique token into the remebered_logins table
  ...
  /**
   * Copy expenses, incomes and payment methods categories from ...default to ...assigned_to_users
   * 
   * @return void
   */
  public function copyCategoriesFromDefaultTables() {
    // Get the user ID
    ...
    */
    ...
    $stmt->bindValue(':user_id', $userId[0][0], PDO::PARAM_INT);
